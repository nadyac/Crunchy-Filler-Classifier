# MakeBagOfFillerWords.py

# loop through a bunch of dict files and extract the words and their counts.
# the point of this is to get the probability of a word showing up in a filler doc
# all the words in this bag come from known filler episodes.
# precondition:
#	assumes that the desired filler files are in the same directory
